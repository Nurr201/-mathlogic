...
const LESSON_REGISTRY = {
  ...
  'algebra.g7.alg-04.property': registryEntry(
    'algebra.g7.alg-04.property', 'LESSON_ALGEBRAIC_FRACTION_PROPERTY',
    'Как основное свойство дроби позволяет находить и сокращать общие множители, не затрагивая слагаемые.',
    'Бөлшектің негізгі қасиеті ортақ көбейткіштерді қосылғыштарға тимей табуға және қысқартуға қалай мүмкіндік беретінін үйренеміз.'
  ),
  'algebra.g7.alg-04.domain': registryEntry(
    'algebra.g7.alg-04.domain', 'LESSON_ALGEBRAIC_FRACTION_DOMAIN',
    'Как находить ноль исходного знаменателя, исключать это значение и сохранять ограничение после сокращения дроби.',
    'Бастапқы бөлімнің нөлін тауып, сол мәнді шығарып, бөлшек қысқартылғаннан кейін де шектеуді сақтауды үйренеміз.'
  ),
  'algebra.g7.alg-04.common-denominator': registryEntry(
    'algebra.g7.alg-04.common-denominator', 'LESSON_ALGEBRAIC_FRACTION_COMMON_DENOMINATOR',
    'Почему для сложения нужны части одного размера, как выбирать общий знаменатель и равносильно приводить к нему алгебраические дроби.',
    'Неліктен қосу үшін бөліктер бірдей болуы керегін, ортақ бөлімді таңдап, алгебралық бөлшектерді соған мәндес келтіруді үйренеміз.'
  ),
  'algebra.g7.alg-04.add-subtract': registryEntry(
    'algebra.g7.alg-04.add-subtract', 'LESSON_ALGEBRAIC_FRACTION_ADD_SUBTRACT',
    'Как привести дроби к общему знаменателю, сложить или вычесть числители, упростить результат и сохранить ограничения.',
    'Бөлшектерді ортақ бөлімге келтіріп, алымдарды қосып не азайтып, нәтижені ықшамдап, шектеулерді сақтауды үйренеміз.'
  ),
  'algebra.g7.alg-04.multiply-divide': registryEntry(
    'algebra.g7.alg-04.multiply-divide', 'LESSON_ALGEBRAIC_FRACTION_MULTIPLY_DIVIDE',
    'Как умножать и делить алгебраические дроби через множители и обратную дробь, возводить всю дробь в степень и сохранять ограничения.',
    'Алгебралық бөлшектерді көбейткіштер мен кері бөлшек арқылы көбейтіп және бөліп, бүкіл бөлшекті дәрежеге шығарып, шектеулерді сақтауды үйренеміз.'
  ),
  'algebra.g7.alg-04.practice': registryEntry(
    'algebra.g7.alg-04.practice', 'LESSON_ALGEBRAIC_FRACTION_TRANSFORMATIONS',
    'Как читать структуру дробного выражения, выбирать следующий допустимый шаг и выполнять смешанные преобразования без потери ограничений.',
    'Бөлшек өрнектің құрылымын оқып, келесі рұқсат етілген қадамды таңдап, шектеулерді жоғалтпай аралас түрлендірулерді орындауды үйренеміз.'
  ),
  ...
  'algebra.g7.alg-05.function-meaning': registryEntry(
    'algebra.g7.alg-05.function-meaning', 'LESSON_FUNCTION_MEANING',
    'Как вход и выход образуют функцию и почему одна зависимость может быть задана словами, формулой, соответствием или таблицей.',
    'Кіріс пен шығыс функцияны қалай құрайтынын және бір тәуелділіктің сөзбен, формуламен, сәйкестікпен немесе кестемен берілуін үйренеміз.'
  ),
  'algebra.g7.alg-05.coordinate-plane': registryEntry(
    'algebra.g7.alg-05.coordinate-plane', 'LESSON_COORDINATE_PLANE',
    'Как упорядоченная пара становится точкой и превращает табличную зависимость в видимую на координатной плоскости.',
    'Реттелген жұптың нүктеге айналып, кестелік тәуелділікті координаталық жазықтықта қалай көрсететінін үйренеміз.'
  ),
  ...
  'algebra.g7.alg-05.linear-position': registryEntry(
    'algebra.g7.alg-05.linear-position', 'LESSON_LINEAR_GRAPH_POSITIONS',
    'Как две линейные прямые пересекаются, идут параллельно или совпадают и как это увидеть по коэффициентам.',
    'Екі сызықтық түзу қалай қиылысатынын, параллель жүретінін не беттесетінін және оны коэффициенттерден қалай көруге болатынын үйренеміз.'
  ),
  'algebra.g7.alg-05.systems-graphically': registryEntry(
    'algebra.g7.alg-05.systems-graphically', 'LESSON_LINEAR_SYSTEMS_GRAPHICALLY',
    'Как общая точка двух графиков становится решением системы и как проверить все три случая.',
    'Екі графиктің ортақ нүктесі жүйе шешіміне қалай айналатынын және үш жағдайды қалай тексеруге болатынын үйренеміз.'
  ),
  'algebra.g7.alg-05.other-functions': registryEntry(
    'algebra.g7.alg-05.other-functions', 'LESSON_OTHER_FUNCTION_GRAPHS',
    'Как таблицы значений становятся параболой, кубической кривой и обратной зависимостью — и как узнавать их по формуле.',
    'Мәндер кестесі параболаға, кубтық қисыққа және кері тәуелділікке қалай айналатынын және оларды формуладан қалай тануды үйренеміз.'
  ),
