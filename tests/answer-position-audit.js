...
const lessons = [
  ...
  { id: 'algebraic-fraction-property', lesson: load('data/lessons/algebraic-fraction-property.js', 'LESSON_ALGEBRAIC_FRACTION_PROPERTY') },
  { id: 'algebraic-fraction-domain', lesson: load('data/lessons/algebraic-fraction-domain.js', 'LESSON_ALGEBRAIC_FRACTION_DOMAIN') },
  { id: 'algebraic-fraction-common-denominator', lesson: load('data/lessons/algebraic-fraction-common-denominator.js', 'LESSON_ALGEBRAIC_FRACTION_COMMON_DENOMINATOR') },
  { id: 'algebraic-fraction-add-subtract', lesson: load('data/lessons/algebraic-fraction-add-subtract.js', 'LESSON_ALGEBRAIC_FRACTION_ADD_SUBTRACT') },
  { id: 'function-meaning', lesson: load('data/lessons/function-meaning.js', 'LESSON_FUNCTION_MEANING') },
  { id: 'coordinate-plane', lesson: load('data/lessons/coordinate-plane.js', 'LESSON_COORDINATE_PLANE') },
...
const expectedCorrectText = {
  ...
  'algebraic-fraction-property': {
    'discover-divide-by-two': 'Разделили числитель и знаменатель на 2',
    'reverse-direction': 'Умножить числитель и знаменатель на 3',
    'one-side-change': '15/21',
    'identify-common-factor': '2x',
    'common-factor-twelve-eighteen': '6a',
    'factor-versus-term': 'Ничего: общего множителя всей дроби нет',
    'nothing-repeated-look': 'Нет, общих множителей нет',
    'choose-factored-form': 'x(x + 2)',
    'exponent-cancellation-check': 'Представляем x³ как x · x · x и сокращаем общий множитель x',
    'mixed-common-factor': '6x',
    'mixed-next-step': '2a/3',
    'final-nothing-cancels': 'Дробь уже не сокращается',
  },
  'algebraic-fraction-domain': {
    'predict-five-over-x': 'x = 0',
    'x-minus-three-choice': 'x = 3',
    'denominator-not-numerator': '2x − 6 = 0',
    'error-analysis-plus-four': 'Нужно решить x + 4 = 0, поэтому x ≠ −4',
    'central-cancellation-prediction': 'Дробь равна 1 при x ≠ 2; x = 2 остаётся запрещённым',
    'cancellation-error-analysis': 'Нужно сохранить a ≠ −5, потому что a + 5 было исходным знаменателем',
    'final-domain-and-simplification': '2 при x ≠ 3',
  },
  'algebraic-fraction-common-denominator': {
    'retrieval-equal-fraction': '3/6',
    'why-not-two-fifths': 'Нужно сначала сделать части одинакового размера',
    'denominator-only-error': 'Нужно умножить и числитель, и знаменатель на 3',
    'choose-numeric-common-denominator': '12',
    'xy-common-denominator': 'xy',
    'extra-multiplier-two-x': '2',
    'six-x-common-denominator': '6x',
    'common-product-choice': 'x(x + 1)',
  },
  'algebraic-fraction-add-subtract': {
    'retrieve-common-denominator': '2x',
    'same-denominator-choice': '(a + b)/x',
    'same-denominator-error': 'Нужно оставить знаменатель x: получится (x + 5)/x',
    'xy-select': 'xy',
    'xy-first-multiplier': 'y',
    'xy-second-multiplier': 'x',
    'subtract-same-denominator': '(a − b)/x',
    'minus-error-analysis': 'Он сложил 1 и 2 вместо вычитания; нужно (x − 1)/y',
    'six-x-pipeline': '6x',
    'no-cancellation-error': 'Нельзя сократить x: в числителе это слагаемое, а не множитель всей суммы',
    'pipeline-concept-check': 'Найти общий знаменатель → привести дроби → выполнить действие с числителями → упростить → сохранить ограничения',
  },
  'function-meaning': {
    'identify-input-output': 'Вход — число билетов, выход — общая стоимость',
    'function-mapping': 'Да: у каждого входа ровно один выход',
    'not-function-mapping': 'Вход 1 имеет два разных выхода',
    'match-representation': 'y = 3x − 2',
    'service-input-output': 'x — число часов, y — полная стоимость',
    'service-function-reason': 'Потому что каждому числу часов соответствует ровно одна полная стоимость',
  },
  'coordinate-plane': {
    'read-labelled-point.followUp': 'A(−3, 2)',
    'origin-check': 'O(0, 0)',
    'order-matters.followUp': 'A и B различаются: в общем случае (x,y) ≠ (y,x)',
    'quadrant-signs.followUp': '(+, −)',
    'form-one-pair': '(−1, 1)',
    'recognize-pair-list': '(−1,1), (0,3), (1,5), (2,7)',
    'final-interpret-points.followUp': 'При входе x = 0 выход y равен 1',
  },
  fractions: {
